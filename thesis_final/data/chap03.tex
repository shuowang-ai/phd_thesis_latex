...
如图\ref{fig:overall_framework}所示，PCDCNet通过三个专门设计的动力学模块来解耦大气过程，分别对应大气污染演化的三类核心物理机制：
...
\textbf{LID（Local Interaction Dynamics）}：建模发生在局地的化学反应和排放生成过程，对应公式\eqref{eq:advection_diffusion}中的化学反应项$R$和排放源项$E$；
