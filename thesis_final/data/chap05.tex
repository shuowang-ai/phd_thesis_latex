...
（2）\textbf{揭示了\PM 与\ozone 的反向演变趋势与协同治理需求。}在所有排放策略下，\cqt{2+26}城市未来\PM 浓度将持续下降（年均$-0.14$至$-0.37$ $\mu$g m$^{-3}$），而\ozone 浓度普遍上升（年均$+0.07$至$+0.22$ $\mu$g m$^{-3}$）。这一\cqt{气候惩罚}效应表明，由于\PM 和\ozone 共享\NOx 和\VOCs 等前驱物且生成机制相互影响，单一污染物控制策略可能引发负面效果，必须根据区域化学敏感性科学确定协同减排比例。该发现也与国家\cqt{双碳}目标高度契合——能源结构转型在减少\COtwo 排放的同时将天然带来空气质量改善的协同效益。
