...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/flowchart_dataflow.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/flowchart_train_deploy.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/api_performance.jpeg}
  \caption{API服务性能监控面板}
...
\begin{figure}[htbp]
  ...
  \subcaptionbox{北京市AQI预报性能\label{fig:online-aqi-beijing}}
    {\includegraphics[width=0.9\linewidth]{figures/online_aqi_metrics_beijing.png}} \\[1ex]
  \subcaptionbox{上海市AQI预报性能\label{fig:online-aqi-shanghai}}
    {\includegraphics[width=0.9\linewidth]{figures/online_aqi_metrics_shanghai.png}} \\[1ex]
  \subcaptionbox{石家庄市AQI预报性能\label{fig:online-aqi-shijiazhuang}}
    {\includegraphics[width=0.9\linewidth]{figures/online_aqi_metrics_shijiazhuang.png}} \\[1ex]
  \subcaptionbox{郑州市AQI预报性能\label{fig:online-aqi-zhengzhou}}
    {\includegraphics[width=0.9\linewidth]{figures/online_aqi_metrics_zhengzhou.png}} 
...
\begin{figure}[htbp]
  ...
  \subcaptionbox{北京市\ozone 预报性能\label{fig:online-o3-beijing}}
    {\includegraphics[width=0.9\linewidth]{figures/online_o3_beijing.jpeg}} \\[1ex]
  \subcaptionbox{广州市\ozone 预报性能\label{fig:online-o3-guangzhou}}
    {\includegraphics[width=0.9\linewidth]{figures/online_o3_guangzhou.jpeg}} \\[1ex]
  \subcaptionbox{上海市\ozone 预报性能\label{fig:online-o3-shanghai}}
    {\includegraphics[width=0.9\linewidth]{figures/online_o3_shanghai.jpeg}} \\[1ex]
  \subcaptionbox{苏州市\ozone 预报性能\label{fig:online-o3-suzhou}}
    {\includegraphics[width=0.9\linewidth]{figures/online_o3_suzhou.jpeg}} 
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/monitor_beijing_lianghui.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/caiyun_web.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/monitoring_accuracy.png}
  \caption{系统运维监控面板}
