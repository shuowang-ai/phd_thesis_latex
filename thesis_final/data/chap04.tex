...
（1）时变物理机理的方向性建模。污染物受风场驱动的平流输送具有强烈的各向异性，而传统基于欧氏距离的插值方法（如IDW、Kriging）假设空间平稳性，难以捕捉\cqt{上风向影响下风向}的定向传输特性。如何将公式（\ref{eq:advection_diffusion}）中的平流项与扩散项显式解耦，分别设计各向异性的平流传播核与各向同性的扩散传播核，是物理约束嵌入的核心问题。
