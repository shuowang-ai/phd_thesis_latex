...
\bnusetup{
  ...
  %   可使用“\\”命令手动控制换行
  %
  title  = {基于物理启发图神经网络的\\大气污染复杂系统建模研究},
  title* = {Modeling Air Pollution Complex Systems\\Based on Physics-Informed Graph Neural Networks},
  %
  % 学科门类
  %   1. 学术型
  %      - 中文
...
% =========================================================
% 污染物（不使用\xspace，xeCJK自动处理CJK-Latin间距；英文语境需手动加{}）
\def\PM{\ensuremath{\mathrm{PM}_{2.5}}}
\def\PMten{\ensuremath{\mathrm{PM}_{10}}}
\def\ozone{\ensuremath{\mathrm{O}_{3}}}
\def\NOx{\ensuremath{\mathrm{NO}_{x}}}
\def\NOtwo{\ensuremath{\mathrm{NO}_{2}}}
\def\VOCs{\ensuremath{\mathrm{VOCs}}}
\def\CO{\ensuremath{\mathrm{CO}}}
\def\SOtwo{\ensuremath{\mathrm{SO}_{2}}}
\def\AOD{\ensuremath{\mathrm{AOD}}}

% 模型名称
\def\ModelPred{\ensuremath{\mathrm{PM}_{2.5}}-GNN}
\def\ModelSurr{PCDCNet}
\def\ModelInfer{SPIN}
\def\ModelSim{IGNN}
\def\SystemName{KnowAir}

% 损失函数
\def\LossAOD{\ensuremath{\mathcal{L}_{\mathrm{AOD}}}}
\def\LossInfer{\ensuremath{\mathcal{L}_{\mathrm{infer}}}}
\def\LossInit{\ensuremath{\mathcal{L}_{\mathrm{init}}}}
\def\LossDIC{\ensuremath{\mathcal{L}_{\mathrm{DIC}}}}

% 评价指标
\def\RMSE{\ensuremath{\mathrm{RMSE}}}
\def\MAE{\ensuremath{\mathrm{MAE}}}
\def\Rsquare{\ensuremath{R^{2}}}
